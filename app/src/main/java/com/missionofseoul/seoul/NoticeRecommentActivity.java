...
public class NoticeRecommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notice_recomment);
        ...
        listview_findrecomment.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (G.mem_id.equals(id)) {
                    Toast.makeText(NoticeRecommentActivity.this, "본인 프로필은 내 활동에서\n확인하실 수 있습니다.", Toast.LENGTH_SHORT).show();
                } else {
                    Intent intent = new Intent(NoticeRecommentActivity.this, AnotherUserActivity.class);
        ...
        new Thread() {
            @Override
            public void run() {
                String serverUrl = G.domain + "php/notice/load_recomment.php";
            ...
            public void run() {
                ...
                if (recomment.equals("")) {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(NoticeRecommentActivity.this, "댓글을 입력해 주세요!", Toast.LENGTH_SHORT).show();
                        }
                    });
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            dialog = new ProgressDialog(NoticeRecommentActivity.this);
                    ...
                    String serverUrl = G.domain + "php/notice/write_recomment.php";
                    ...
                    try {
                        ...
                        /*String data = "id=" + G.mem_id + "&comm_no=" + comm_no + "&recomment=" + recomment;
                        OutputStream os = connection.getOutputStream();
                        os.write(data.getBytes());
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                if (result.equals("success")) {
                                    Toast.makeText(NoticeRecommentActivity.this, "댓글이 저장되었습니다.", Toast.LENGTH_SHORT).show();
                                    ...
                                    Toast.makeText(NoticeRecommentActivity.this, "댓글 저장에 실패했습니다\n네트워크가 불안정합니다.", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                        is.close();
