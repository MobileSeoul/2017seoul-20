...
public class FindRecommentAdapter extends BaseAdapter {
    ...
    public FindRecommentAdapter(ArrayList<CastRecommBeen> recommBeens, LayoutInflater inflater, RequestManager mGlideRequestManager) {
