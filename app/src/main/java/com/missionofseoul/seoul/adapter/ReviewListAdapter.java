...
public class ReviewListAdapter extends BaseAdapter {
    ...
    public ReviewListAdapter(ArrayList<ReviewBean> reviewBeen, LayoutInflater inflater, RequestManager requestManager) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            mGlideRequestManager.load(G.domain + review.getProfileImg()).bitmapTransform(new CropCircleTransformation(convertView.getContext()))
                    .diskCacheStrategy(DiskCacheStrategy.SOURCE).into(profie_img);
